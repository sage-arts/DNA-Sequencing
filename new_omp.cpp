...
{
     int i,j;
     #pragma omp parallel private(i,j) shared(u,x)
     {
     ...
     #pragma omp parallel private(j) shared(u)
     {
          #pragma omp for
          for(j=0;j<M;j++)
          {
...
{
     int i,j;
     #pragma omp parallel private(i,j) shared(x,xt)
     {
          #pragma omp for collapse(2)
          for(i=0;i<n;i++)
          {
...
{
     int i,j,k;
     #pragma omp parallel private(i,j,k) shared(x,xt,cov)
     {
     ...
     #pragma omp parallel private(i,j) shared(cov)
     {
          #pragma omp for collapse(2)
          for(i=0;i<M;i++)
          {
...
{
     int i,j;
     #pragma omp parallel private(i,j) shared(cov,icov)
     {
          #pragma omp for collapse(2)
          for(i=0;i<M;i++)
          {
...
{
     int i,j;
     #pragma omp parallel private(i,j) shared(vec,icov,vec1)
     {
          #pragma omp for collapse(2)
          for(i=0;i<M;i++)
          {
